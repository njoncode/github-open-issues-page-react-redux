        ...
        <div className='main-header'>
            ...
            <ul className='pagehead-actions'>
                ...
                <li>
                    ...
                    <a className="social-count" href="/facebook/create-react-app/watchers" aria-label="1916 users are watching this repository" data-target="notifications-list-subscription-form.socialCount">
                        {watch}
                    </a>
                </li>
                <li>
                    ...
                    <a className="social-count js-social-count" href="/facebook/create-react-app/stargazers" aria-label="89329 users starred this repository">
                        {star}
                    </a>
                </li>
                <li>
                    <button className='btn btn-sm btn-with-count' onClick={handleOnClick}>
                        ...
                        <a href="/facebook/create-react-app/network/members" className="social-count" aria-label="22462 users forked this repository">
                            {fork}
                        </a>
                </li>
            </ul>
